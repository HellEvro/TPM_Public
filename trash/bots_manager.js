 ...
 *
 * ⛔ ДЛЯ ИИ-АГЕНТОВ И РАЗРАБОТЧИКОВ: НЕ РЕДАКТИРУЙТЕ ЭТОТ ФАЙЛ!
 *
 * Активный код перенесён в модули:
 *   static/js/managers/bots_manager/00_core.js ... 16_timeframe.js, index.js
 *
 * Все изменения логики BotsManager вносите в соответствующий модуль в папке bots_manager/.
 * Этот файл — только резервная копия; в работе используется загрузка модулей из index.html.
 *

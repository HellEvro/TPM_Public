...
DEFAULT_AUTO_BOT_CONFIG = {
    ...
    'rsi_long_threshold': 23, # Вход в LONG при RSI <= 29
    ...
    # Защитные механизмы
    'max_loss_percent': 2.5, # Максимальный убыток в % от входа (стоп-лосс)
    ...
    'trailing_take_distance': 2.5, # Резервный trailing-тейк (лимит) в %, когда процесс упадет
    ...
    'rsi_time_filter_candles': 10, # Минимум свечей с последнего экстремума (4 = 1 день на 6H)

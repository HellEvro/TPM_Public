...
DEFAULT_AUTO_BOT_CONFIG = {
    ...
    'break_even_trigger_percent': 2, # Дублирующий ключ для UI (совместимость)
    # Фильтры по тренду
...
class SystemConfig:
    ...
    POSITION_SYNC_INTERVAL = 2 # 30 секунд - интервал синхронизации позиций с биржей
    MINI_CHART_UPDATE_INTERVAL = 30 # 7 минут - интервал обновления миниграфиков RSI (в секундах)
